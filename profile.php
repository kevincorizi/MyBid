...
<main>
    ...
    <section>
        ...
        <article>
            ...
            <?php else: ?>
                <h2 id="current_thri_value">Your current bid for the auction <?php echo $auction->name; ?>
                    is <?php echo $offer->value; ?>€.</h2>
        ...
        <article>
            ...
            <?php else: ?>
                <h2>You have <span id="notification_count"><?php echo count($notifications); ?></span> notifications
                </h2>
            <?php endif; ?>
            <?php foreach ($notifications as $notification): ?>
                <div id="notification_<?php echo $notification->id; ?>"
                     class="message_container notification_message_container">
